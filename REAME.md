...
| 6/16                  | 1   | C016:Leet 文字列            |      |
| 6/16                  | 2   | D070:残りのページ           |      |
| 6/16                  | 3   | D056:忘年会の予算           |      |
| 6/17                  | 1   | C055:ログのフィルター       |      |
| 6/17                  | 2   | D109:ゾロ目の日付           |      |
| 6/17                  | 3   | D090:下一桁はいくつ         |      |
| 6/18                  | 1   | C078:株の売買               |      |
| 6/18                  | 2   | D068:雨と晴れの記録         |      |
| 6/18                  | 3   | D060:A ボタンと B ボタン    |      |
...
| 6/18 | 〈ex-03〉<br>① 環境構築<br>（create-react-app 　いらないファイルを削除） <br>② ファイル構成や、コンポーネント（部品）の構成で画面を構成するか、紙に書き出す<br>③ 大まかなファイルの枠組みを作る（App.jsx index.js）<br>④1 表示させたい項目がきちっと表示させられるか確認<br>⑤ コンポーネント化させる<br>⑥CSS を調整 |                                                                                                                                                                                                                                                                        |
| 6/19 | 4:00-レッスン                                                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                        |
