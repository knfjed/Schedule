...
| 6/9  | 見本を３つ見つける（モデル）<br>どんな構成なのか、親子関係、デザインの構成要素を分析<br>（要素ごとのサイズ感や余白の取り方、要素毎の位置関係、高さや幅、縦のラインの揃え方など）<br>コンポーネントやファイルの構成を紙に書き出して整理する(1h)<br>環境構築・いらないファイルの整理(30min) |      |
